...
# User aliases
alias pic='feh --cache-size 1024 -g 940x780 --auto-zoom --scale-down $1'
alias dmess='sudo dmesg -HL --color=auto | command bat -l "Bourne Again Shell (bash)"'
alias lsbla='lsblk --output NAME,SIZE,TYPE,FSTYPE,LABEL,FSSIZE,FSUSED,FSAVAIL,FSUSE%,PATH,MOUNTPOINTS | command \bat -l perl'
alias free='free -htl'
alias curlme='curl https://ident.me/json | jq '.' '
...
alias fd='sudo /usr/bin/fd --hidden -u -L -d 10 --color=auto --exclude /sys --exclude /proc -- '
alias lc='wc --lines'
